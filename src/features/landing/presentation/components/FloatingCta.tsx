    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          /* 
            On mobile: full-width bar pinned to bottom of safe area
            On desktop: compact pill at bottom-right
          */
          className="fixed bottom-0 left-0 right-0 z-50 px-4 pb-[env(safe-area-inset-bottom,12px)] pt-2 bg-gradient-to-t from-[#07090F] to-transparent sm:bottom-6 sm:left-auto sm:right-5 sm:px-0 sm:pt-0 sm:bg-none"
        >
          <a
            href={url}
            target="_blank"
